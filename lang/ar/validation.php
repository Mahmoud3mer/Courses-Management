...
return [
    ...
    */
    ...
    'between' => [
        ...
        'string' => 'يجب أن يحتوي نص :attribute على بين :min و :max أحرف.',
    ],
    ...
    'digits_between' => 'يجب أن يكون حقل :attribute بين :min و :max أرقامًا.',
    'dimensions' => 'يجب أن يحتوي حقل :attribute على أبعاد صورة غير صالحة.',
    'distinct' => 'يجب أن يحتوي حقل :attribute على قيمة مكررة.',
    ...
    'gt' => [
        ...
        'string' => 'يجب أن يحتوي نص :attribute على أكثر من :value أحرف.',
    ],
    'gte' => [
        ...
        'string' => 'يجب أن يحتوي نص :attribute على أكثر من أو يساوي :value أحرف.',
    ],
    ...
    'lt' => [
        ...
        'string' => 'يجب أن يحتوي نص :attribute على أقل من :value أحرف.',
    ],
    'lte' => [
        ...
        'string' => 'يجب أن يحتوي نص :attribute على أقل من أو يساوي :value أحرف.',
    ],
    ...
    'max' => [
        ...
        'string' => 'يجب ألا يحتوي نص :attribute على أكثر من :max أحرف.',
    ],
    ...
    'min' => [
        ...
        'string' => 'يجب أن يحتوي نص :attribute على الأقل على :min أحرف.',
    ],
    ...
    'not_in' => 'يجب أن يكون حقل :attribute المحدد غير صالح.',
    'not_regex' => 'يجب أن يكون تنسيق حقل :attribute غير صالح.',
    'numeric' => 'يجب أن يكون حقل :attribute رقمًا.',
    'password' => [
        'letters' => 'يجب أن يحتوي حقل :attribute على الأقل على حرف واحد.',
        'mixed' => 'يجب أن يحتوي حقل :attribute على الأقل على حرف كبير واحد وحرف صغير واحد.',
    ...
    'prohibited_if_accepted' => 'يجب أن يكون حقل :attribute محظورًا عندما يكون :other مقبولًا.',
    'prohibited_if_declined' => 'يجب أن يكون حقل :attribute محظورًا عندما يكون :other مرفوضًا.',
    'prohibited_unless' => 'يجب أن يكون حقل :attribute محظورًا ما لم يكن :other في :values.',
    'prohibits' => 'يجب أن يكون حقل :attribute محظورًا :other من الوجود.',
    'regex' => 'يجب أن يكون تنسيق حقل :attribute غير صالح.',
